## CompanyPeopleManagementReactRedux

Playground work for Company People Management System - React + Redux (BASED On [React Starter Kit](https://www.reactstarterkit.com) boilerplate)
